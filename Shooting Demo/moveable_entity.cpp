...
void MoveableEntity::update(const Shader& shader, const glm::vec3& pos) {
	this->pos = pos;
...
void MoveableEntity::update(const Shader& shader, const glm::vec3& pos, const glm::vec3& scale) {
	this->pos = pos;
	this->scale = scale;
...
void MoveableEntity::update(const Shader& shader, const glm::vec3& pos, const glm::vec3& rotation_axis, float rotation_angle) {
	this->pos = pos;
	this->rotation_axis = rotation_axis;
	this->rotation_angle = rotation_angle;
...
void MoveableEntity::update(const Shader& shader, const glm::vec3& pos, const glm::vec3& scale, const glm::vec3& rotation_axis, float rotation_angle) {
	this->pos = pos;
	this->scale = scale;
	this->rotation_axis = rotation_axis;
	this->rotation_angle = rotation_angle;
