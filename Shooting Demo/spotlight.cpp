...
const int SpotLight::MAX_SPOT_LIGHTS = 16;
int SpotLight::num_spot_lights = 0;

SpotLight::SpotLight(const std::string& uniform_name, const glm::vec3& ambient, const glm::vec3& diffuse, const glm::vec3& specular, const glm::vec3& pos, const glm::vec3& direction,
